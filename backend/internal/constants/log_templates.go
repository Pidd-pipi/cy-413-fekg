...
const (
	...
	LogWeeklyReportGenerated = "WeeklyReport generated with average_mood and valid_days"
	LogWeeklyReportRead      = "WeeklyReport snapshot read"
	LogWeeklyReportReused    = "WeeklyReport snapshot reused without overwrite"
